      ...
      <v-layout row wrap>
        ...
        <v-flex xs12 class="category-blog pa-2">
          <v-tabs>
            ...
            <v-tab to="/blog/category/fptvi-2020">FPTVI 2020</v-tab>
            <v-tab to="/blog/category/kongres-vokasi">Kongres Vokasi</v-tab>
            <v-tab to="/blog/category/olivia-2020">Olivia 2020</v-tab>
          </v-tabs>
        </v-flex>
        <v-flex
...
export default {
  ...
  async asyncData ({ app, isDev, route, store, env, params, query, req, res, redirect, error }) {
    ...
    return { blogs, category: params.category }
  },
  data: () => ({
  }),
  computed: {
